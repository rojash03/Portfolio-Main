    ...
    <>
      ...
      <div className="flex flex-col lg:flex-row w-full min-h-[30rem] px-4 md:px-8 lg:px-40 items-center py-8 lg:py-0">
        ...
        <AnimatedSection animation="fade-right" className="w-full lg:w-[60%] lg:ml-12 text-justify h-full flex flex-col justify-center">
          ...
          <p className="mt-4">
            I am a full-stack focused developer with a strong foundation in
            software engineering, problem solving, and system design. I work
            comfortably across both frontend and backend technologies, building
            responsive user interfaces and scalable server-side logic using
            JavaScript, React, and Node.js. My approach emphasizes clean
            architecture, efficient code, and practical solutions to real-world
            problems.
          </p>
          <p className="mt-4">
            ...
            practices, and approach every problem with a structured and
          ...
          },
          {
            ...
            content: (
              <ul className="space-y-2">
                {["Ethical Hacking", "Web Development", "Mobile App Development", "Cybersecurity"].map((item) => (
          ...
          },
          {
            ...
            content: (
              <ul className="text-gray-700 space-y-2">
                {["Become a Full Stack Developer", "Open Source Projects", "Learn Cloud Computing", "Research Publication"].map((item) => (
                  <li key={item} className="flex items-center justify-center">
                    <span className="w-2 h-2 bg-secondary rounded-full mr-3"></span>
                    {item}
                  </li>
